...
ModuleExercise2::ModuleExercise2(ModuleD3D12* d3D12) : d3d12(d3D12)
{
}
...
bool ModuleExercise2::createVertexBuffer()
{
	struct Vertex
	{
		float x, y, z;
...
bool ModuleExercise2::createRootSignature()
{
...
bool ModuleExercise2::createPSO()
{
